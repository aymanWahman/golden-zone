...
const Footer = () => {
  return (
    <div className='justify-center bg-transparent rounded-t-xl border-2 border-yellow-600 shadow-2xl'>
    ...
    <div><p className='text-xs text-center text-gray-300'>Design by Ayman Aly</p></div>
    </div>
  );
}
